...
const products = [
  {
    id: 1,
    name: "Смартфон Apple iPhone 17 Pro 256 ГБ синий",
    specs: "6.3', 2622x1206, Super Retina XDR, 120 Гц, 3G, 4G, 5G, eSIM, Nano-SIM",
    reviews: 5,
  ...
  return (
    <div className="smartphones-page">
      <div className="container6">
        ...
        {/* Заголовок */}
        <h1 className="text-2xl font-bold text-gray-900 mb-4">Смартфоны (9 товаров)</h1>

        {/* Фильтры */}
        <div className="filters flex flex-wrap gap-2 mb-4">
          {[
            'Android', 'ios', '2025 года', 'С беспроводной зарядкой',
            'Игровые', 'Для селфи', 'Большие', 'Со стилусом', 'Маленькие', 'GPS', 'С мультитач'
          ].map((filter, idx) => (
            <button
              key={idx}
