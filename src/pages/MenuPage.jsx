        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center py-6">
            ...
            <nav className="flex flex-wrap justify-center gap-4 md:gap-8 text-lg font-semibold">
              ...
              <Link to="/menu" className="text-fuchsia-300 underline underline-offset-4 drop-shadow-[0_0_8px_rgba(255,0,255,0.8)]">МЕНЮ</Link>
            </nav>
          </div>
        </div>
      </header>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            <div className="flex flex-wrap justify-center gap-6 mb-6">
              ...
              <Link to="/menu" className="text-fuchsia-300 drop-shadow-[0_0_5px_rgba(255,0,255,0.5)]">Меню</Link>
            </div>
